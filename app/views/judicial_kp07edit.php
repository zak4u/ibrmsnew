      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Form Details | KP Form No.:
            <input  name="CaseNum"  type="text" class="readonly readonlyfld" readonly value="KP07-17-1007144525" />
            For Case No.:
            <input  name="kp07Num"  type="text" class="readonly readonlyfld" readonly value="BCN-17-1007144525" />
          </h3>
        </div>
