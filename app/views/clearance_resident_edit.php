...
if ($lists) {
    foreach ($lists as $list) {
        ?>
        <form  action="<?php echo base_url('clearance/edit_clearance_resident/'.$list->res_id); ?>" method="post" name="resident_clearance_form" class="validate">
            <div class="row">
                <div class="col-lg-12">
                    <div class="box box-primary">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea name="PurposeOfClearance" type="text" class="form-control" style="height: 80px;"><?php echo $list->rc_purpose; ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="O.R. Number">O.R. Number <span class="req">*</span></label>
                                <input name="ornum" id="ornum" type="text" class="form-control" autocomplete="off" placeholder="Enter O.R. Number" value="<?php echo $list->rc_or_number; ?>" />
                            </div>
                            <div class="form-group">
