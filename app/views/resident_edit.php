        ...
        <div class="col-lg-6">
          <div class="box-body">
            ...
            <div class="form-group res-photo">
              ...
              <input type="file" id="">
              <br/>
              <img style="width: 70px" src="<?php echo base_url(); ?>resident-photo/lyndon-astorga-200.jpg" alt="" />
        ...
        <div class="col-lg-6">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="form-group"><input type="submit" value="Update Record" class="btn btn-block btn-success btn-lg bigassbtn" /></div>
            <!-- /.form-group --> 
          </div>
        </div>
        <!-- right END -->
