            ...
            <div class="box box-primary">
                ...
                <div class="col-lg-6">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Barangay Captain Name" />
                        </div>
                        <div class="form-group">
                            <label for="BarangayKagawad">Barangay Kagawad 1 <span class="req">*</span></label>
                            <input type="text" class="form-control" placeholder="Enter Barangay Kagawad Name" />
                        </div>
                        <div class="form-group">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Barangay Secretary Name" />
                    </div>
                    <div class="form-group">
                        <label for="BarangayTreasurer">Barangay Treasurer <span class="req">*</span></label>
                        <input type="text" class="form-control" placeholder="Enter Barangay Treasurer Name" />
                    </div>
