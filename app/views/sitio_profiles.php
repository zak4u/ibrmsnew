<div class="row">
    ...
    <div class="col-lg-4 col-xs-12"><div class="pull-right"><a href="<?php echo base_url(); ?>purok/add" class="btn btn-success">Add New Sitio</a></div></div>
    <div class="clearboth"></div>
    <br/><br/><br/><br/>
    <div class="col-lg-12">
        <h4>Sitio Profile List</h4>
