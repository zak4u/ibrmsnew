...
class resident_m extends CI_Model{
    ...
    public function add_resident_m(){
        $form_fields = array(
            ...
            'res_spouse' =>trim(stripslashes($this->input->post('Spouse'))),
    ...
    public function edit_resident_m(){
        $pid = $this->input->post('resident_id');
        
        $form_fields = array(
            'resident_name' =>ucwords(strtolower(trim(stripslashes($this->input->post('resident_name'))))),
            'resident_address' =>ucwords(strtolower(trim(stripslashes($this->input->post('resident_address'))))),
            'resident_lat' =>trim(stripslashes($this->input->post('resident_lat'))),
            'resident_long' =>trim(stripslashes($this->input->post('resident_long'))),
            'resident_president' =>ucwords(strtolower(trim(stripslashes($this->input->post('resident_president'))))),
            'resident_vice_president' =>ucwords(strtolower(trim(stripslashes($this->input->post('resident_vice_president'))))),
            'resident_secretary' =>ucwords(strtolower(trim(stripslashes($this->input->post('resident_secretary'))))),
            'resident_treasurer' =>ucwords(strtolower(trim(stripslashes($this->input->post('resident_treasurer')))))
        );
        
        $this->db->where('resident_id', $pid);
